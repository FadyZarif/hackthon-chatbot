...
class ChatTravelScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Builder(builder: (context) {
      ...
      if (chatCubit.startStation == null) {
        ChatCubit.get(context)
            .botSendMessage(
            'مرحبا بك فى خدمة حجز تذكرة القطار رجاء ادخل محطة القيام',
            serviceID)
            .then((value) {
      ...
      return BlocConsumer<ChatCubit, ChatStates>(listener: (context, state) {
        if (state is ChatUserSendMessageSuccessState) {
          ChatCubit.get(context).travelSequence(msg!, serviceID,context);
        }
